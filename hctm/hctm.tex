...
\infrule[Par-barb]{\mbox{$P\downarrow_{\mathcal N} x$ or $Q\downarrow_{\mathcal N} x$}}
      {{P} \juxtap {Q} \downarrow_{\mathcal N} x}
...
\begin{equation*}
  \begin{aligned}
    & \meaningof{\pzero} \defneqls
    \begin{pspicture}(-1,1)(0,2.5)
      \rput(0,2){\ovalnode{A}{$0$}}
      \pnode(0,0){B}
      \nccurve{A}{B} \naput{$P$}
    \end{pspicture} \\
    & \meaningof{{x}{?}{( y_1, \ldots, y_n )} \Rightarrow {Q}} \defneqls
    \begin{pspicture}(-1,2)(0,5.5)
      \rput(1,2){\ovalnode{A}{$?_n$}}
      \pnode(1,0){B}
      \nccurve{A}{B} \naput{$P$}
      \rput(0,4){\ovalnode{C}{$x$}}
      \nccurve[angleB=135]{C}{A} \naput{$N$}
			\rput(2,4){\ovalnode{D}{$curry(Q)$}}
      \nccurve[angleA=65,angleB=-135]{A}{D} \ncput[npos=.65]{\pnode{clasp1}}
      \nccurve[angleA=-90,angleB=35]{D}{A} \naput{$N^{\otimes n}\multimap P$} \ncput[npos=.25]{\cnode{4pt}{clasp2}}
      \nccurve[angleA=0,angleB=180,ArrowInside=]{clasp1}{clasp2}
    \end{pspicture} \\
    & \meaningof{{x}{!}{( y_1, \ldots, y_n )}} \defneqls 
    \begin{pspicture}(-1,2)(0,6.5)
      \rput(1,2){\ovalnode{A}{$!_n$}}
			\pnode(1,0){B}
      \nccurve{A}{B} \naput{$P$}
      \rput(0,4){\ovalnode{C}{$x$}}
      \nccurve[angleB=135]{C}{A} \naput{$N$}
      \rput(2.5,4){\ovalnode{D}{$y_1 \otimes \cdots \otimes y_n$}}
      \nccurve[angleB=45]{D}{A} \naput{$N^{\otimes n}$}
    \end{pspicture} \\
    & \meaningof{\binpar{Q}{Q'}} \defneqls 
		\begin{pspicture}(-1,2)(0,5.5)
			\rput(0,3){\ovalnode{A}{$Q$}}
			\rput(2,3){\ovalnode{B}{$Q'$}}
...
\vspace{10mm}
\\
Note that in the string diagrams, only free names appear as inputs; bound names appear only as internal wires, so the model automatically satisfies alpha equivalence.
