...
\begin{itemize}
  ...
  \item a 1-morphism $COMM\maps 1 \to P,$
    \[\begin{pspicture}(0,0)(0,2.5)
      ...
      \nccurve{A}{B} \naput{$P$}
    \end{pspicture}\]  
  \item a 2-morphism $comm$ encoding the COMM rule, and
