...
formalisms. It is worth noting that even when modeling such
fundamental calculi as the lazy lambda calculus, attempting to use
higher categorical notion to capture a more operational semantics is
still faced with this challenge. Fortunately, the techniques developed
here extend to that setting, as we sketch at the end.
