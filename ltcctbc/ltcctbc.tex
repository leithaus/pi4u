...
linear proofs and π-calculus processes. In this context it means that
...
\begin{equation*}
  \begin{aligned}
    C_1 = Block\{ 1AliceAddr \xrightarrow{5btc} 1AllanAddr \} \leftarrow Block\{ 1BobAddr \xrightarrow{7btc} 1BettyAddr \} \\
    C_2 = Block\{ 1BobAddr \xrightarrow{7btc} 1BettyAddr \} \leftarrow Block\{ 1AliceAddr \xrightarrow{5btc} 1AllanAddr \}
  \end{aligned}
\end{equation*}
...
\begin{equation*}
  \begin{aligned} 
    C_1 = Block\{ 1AliceAddr \xrightarrow{5btc} 1AllanAddr \} \leftarrow Block\{ 2BobAddr \xrightarrow{7btc} 2BettyAddr \}
    C2 = Block\{ 1BobAddr \xrightarrow{7btc} 1BettyAddr \} \leftarrow Block\{ 2AliceAddr \xrightarrow{5btc} 2AllanAddr \}
  \end{aligned}
\end{equation*}
...
\begin{equation*}
  \begin{aligned} 
    C_1 \otimes C_2 \\
    & = \\
    Block\{ 1AliceAddr \xrightarrow{5btc} 1AllanAddr \} \otimes Block\{ 1BobAddr \xrightarrow{7btc} 1BettyAddr \}  \\
    & \leftarrow Block\{ 2BobAddr \xrightarrow{7btc} 2BettyAddr \} \otimes Block\{ 2AliceAddr \xrightarrow{5btc} 2AllanAddr \}
    & = \\
    Block\{ 1AliceAddr \xrightarrow{5btc} 1AllanAddr ; 1BobAddr \xrightarrow{7btc} 1BettyAddr \} \\
    & \leftarrow Block\{ 2BobAddr \xrightarrow{7btc} 2BettyAddr ; 2AliceAddr \xrightarrow{5btc} 2AllanAddr \}
  \end{aligned}
\end{equation*}
...
\begin{equation*}
  \begin{aligned} 
    ...
    & = \\
    Block\{ 1AliceAddr \xrightarrow{5btc} 1AllanAddr \} \otimes Block\{ 1BobAddr \xrightarrow{7btc} 1BettyAddr \} \\
    & <- Block\{ 1BobAddr \xrightarrow{7btc} 01BettyAddr \} * Block\{ 1AliceAddr \xrightarrow{5btc} 11AllanAddr \} \\
    & = \\
    Block\{ 01AliceAddr \xrightarrow{5btc} 01AllanAddr ; 11BobAddr \xrightarrow{7btc} 11BettyAddr \} \\
    & \leftarrow Block\{ 01BobAddr \xrightarrow{7btc} 01BettyAddr ; 11AliceAddr \xrightarrow{5btc} 11AllanAddr \}
  \end{aligned}
\end{equation*}
