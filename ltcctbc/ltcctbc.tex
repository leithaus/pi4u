...
$M$ $\mathsf{satoshi}$ to $2blkchnaddr$, in the context of the genesis
...
$\mathsf{txn}\mathsf{(} 2blkchnaddr, M \cdot \mathsf{satoshi} \mathsf{)}$

To spend a smaller amount than the entirety of the resources at
$1blkchnaddr$ the reader can check that there is an input-style
accounting that exactly mimics the current blockchain semantics.
