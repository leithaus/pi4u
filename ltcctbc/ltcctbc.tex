...
of games \cite{DBLP:conf/lics/AbramskyM99}, and here's another that interprets them in terms of
traditional computational calculi like the lambda calculus \cite{DBLP:journals/tcs/Abramsky93}.
...
for example, Abramsky extended it to proofs as processes \cite{DBLP:journals/tcs/Abramsky94}, which Wadler
...
\begin{mathpar}
  \inferrule* {\vdash G, t : A}{ \vdash inl( t ) : A + B }
\end{mathpar}
