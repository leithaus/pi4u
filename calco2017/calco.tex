...
Gph-enriched categories are part of a spectrum of 2-category-like structures.  A strict 2-category is a Any strict 2-category has an underlying sesquicategory and any sesquicategory has an underlying Gph-enriched category.  These forgetful functors have left adjoints
...
\begin{center}
\AXC{$x_0 \equiv_N x_1$} 
\UIC{$x_0!Q \;|\; x_1?y.P \;\to\;P\{\&Q / y\}$} \DP \quad \quad
\end{center}
