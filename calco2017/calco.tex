...
There is a long history and an enormous body of work on modeling term rewriting and operational semantics with various notions of category enriched over category-like structures; we only have room here for a sampling.  Seely \cite{DBLP:conf/lics/Seely87} 
...
expands Seely's work by exploring the proof theory using categorical logic.  Hirschowitz \cite{DBLP:journals/corr/Hirschowitz13}
...
Melli\`es
% P. Mellie`s, Axiomatic rewriting theory I: a diagrammatic standardisation theo- rem, in Processes, Terms and Cycles: Steps on the Road to Infinity, Lecture Notes in Computer Science 3838, Springer, 2005, pp. 554–638. Also available at https://hal.archives-ouvertes.fr/hal-00151276/PDF/jwkfestschrift.pdf
