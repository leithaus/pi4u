...
Given a monoidal 2-category $(M, I, \otimes)$ with a distinguished object $G,$ we can think of a morphism $f\colon I \to G$ as a configuration of the state of a computer and a 2-morphism $\alpha\colon f \Rightarrow f'$ as a reduction between states.
