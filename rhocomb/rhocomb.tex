...
\end{definition}
\[\begin{array}{rl}
  \mathsf{*}_{(x,v,w)} P &= \mathsf{m}(x,D(x,v,w) \; |\; P) \; |\; D(x,v,w) \\
...
(I)&  \meaningof{\prefix{p}{x}{\binpar{P}{Q}}}_4(n, q) 
    ...
    & & & \mbox{where $v = \quotep{(\mathsf{m}(q,\binpar{\mathsf{b}_{\mathsf{l}}(q,n)}{\binpar{P}{Q}}))}$, $w = \quotep{(\mathsf{m}(q,\binpar{\mathsf{b}_{\mathsf{r}}(q,n)}{\binpar{P}{Q}}))}$,} \\
    & & &\mbox{$n_{1} = \quotep{(\binpar{\mathsf{b}_{\mathsf{l}}(v,w)}{\mathsf{m}(q,\mathsf{m}(v,*w))})}$, $n_{2} = \quotep{(\binpar{\mathsf{b}_{\mathsf{r}}(v,w)}{\mathsf{m}(q,\mathsf{m}(v,*w))})}$} \\
    & & &\mbox{$q_{1} = \quotep{(\binpar{\mathsf{b}_{\mathsf{l}}(n_{1},n_{2})}{\mathsf{m}(q,\mathsf{m}(v,*w))})}$, $q_{2} = \quotep{(\binpar{\mathsf{b}_{\mathsf{r}}(n_{1},n_{2})}{\mathsf{m}(q,\mathsf{m}(v,*w))})}$} \\
...
(XII)&  \meaningof{\prefix{p}{x}{\mathsf{b}_{\mathsf{r}}(v,x^{-})}}_4(n, q) 
    ...
    & & & \mbox{where $w_{1} = \quotep{(\binpar{\mathsf{b}_{\mathsf{l}}(q,n)}{\mathsf{m}(q,\mathsf{b}_{\mathsf{r}}(v,x^{-}))})}$, $w_{2} = \quotep{(\binpar{\mathsf{b}_{\mathsf{r}}(q,n)}{\mathsf{m}(q,\mathsf{b}_{\mathsf{r}}(v,x^{-}))})}$,} \\
