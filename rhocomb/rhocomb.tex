...
implementations in \textsf{OCaml}, \textsf{Haskell}, and
\textsf{Scala} used exactly this fixed point formulation to define the
syntax for the {\rhoc}. The fact that the code type-checks
proves that the types are inhabited, providing some assurance of the
