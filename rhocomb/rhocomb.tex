...
\section{Introduction}
  ...
  Enriched Lawvere theories \cite{GhaniLuth} 
...
provide a structure for representing not only the signature of terms in a calculus, but also the reduction relation on those terms.
...
Yoshida's original combinator calculus
...
We remove new names and replication and introduce quoting/unquoting operators, then allow processes in the second argument of a send.
