...
\begin{mathpar}
  \inferrule* [lab=summation] {} {{P,Q} \bc \pzero \;|\; \mathsf{for( y \leftarrow x)P } \;|\; x!(Q) \;|\;P|Q \;|\; \dropn{x} }
  \and
...
names, and $\id{\{}\vect{y} / \vect{x} \id{\}}$ to denote partial maps,
...
\begin{mathpar}
  ...
  (\mathsf{for}( y \leftarrow x)R) \psubstp{Q}{P}    
  :=    
...
\begin{mathpar}
  \inferrule* [lab=Comm] { x_{src} \nameeq x_{trgt} \\ \vect{y} \cap \vect{v} = \emptyset \\ |\vect{y}| = |\vect{z}|} { R_{L} + x_{trgt}?(\vect{y})P \; | \; x_{src}\clift{\vect{Q}} + R_{R} \red P\{\vect{\quotep{Q}}/\vect{y}\} }
  \and \\
