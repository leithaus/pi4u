...
Because the $\mathsf{new}$ operator is interpreted as a prefix
operator, to handle its elimination we must essentially import all of
Yoshida's prefix elimination algorithm. Like her, we assume the following
annotations (+ stands for the output and − stands for the input),
...
\begin{eqnarray*}
  \meaningof{\prefix{p}{x}{P|Q}}_4(n, q) 
    & := & 
    (d(p,v,w)|\binpar{\meaningof{\prefix{v}{x}{P}}_{4}(n, q'_{1})}{\meaningof{\prefix{w}{x}{Q}}_{4}(n, q'_{2}) } \\
    & & \mbox{where $v = \quotep{m(q(b_{l}(q,n)|P|Q))}$, $w = \quotep{(m(q,b_{r}(q,n)|P|Q))}$,} \\
    & & \mbox{$q'_{1} = \quotep{\binpar{b_{l}(v,w)}{m(q(m(v,w)))}}$, $q'_{1} = \quotep{\binpar{b_{r}(v,w)}{m(q(m(v,w)))}}$} \\
  ...
  \meaningof{\prefix{p}{x}{(b_{r}(v,x^{-}))}}_4(n, q) 
    ...
    & & \mbox{$w_{3} = @(b_{r}(p,v)|b_{r}(v,x^{-}))$, and $q' = s(w_{1},w_{2w_{3}})$} \\
