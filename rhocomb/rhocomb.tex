...
parameterized in a theory of names, we instantiated her calculus with
...
The template for an observation relation on both calculi is given by
...
second position in the message combinator, $m(x-)$, i.e. the payload
of the message. For in the rho combinators the payload is a process,
