...
\begin{eqnarray*}
    ...
    \meaningof{\id{!} P}_2 (n,p,x)
      & = & \binpar{m(x,\meaningof{P}_3(n^r,p^r,x^r))}
                 {\binpar{D(x)}{\binpar{m(n^r,n^l)}{m(p^r,p^l)}}} \\
    \meaningof{(\new \; y ) P}_2 (n,p,x) 
      & = & 
    \prefix{p}{y}{\binpar{\meaningof{P}_2 (n^l,p^l,x^l)}{\outputp{p}{n}}} \\
\end{eqnarray*}
