...
translated. For example, in rule $I$, for prefix to a parallel
...
must update the name allocator in the recursive call. We do not
have to import rules 2 - 4 of her algorithm. Like her, we assume the
following annotations (+ stands for the output and − stands for the
input), which denote how each name is used in the rules of
interaction:
...
(X)&  \meaningof{\prefix{p}{x}{\emph{c}(\vect{v},x^{+},\vect{w})}}_4(n, q) 
    ...
    & & & \mbox{where $a = @(\binpar{m(q,*n)}{\emph{c}(v^{-},w)})$} \mbox{ and $n'= \quotep{(m(a,m(q,n)))}$} \\
...
(XII)&  \meaningof{\prefix{p}{x}{(b_{r}(v,x^{-}))}}_4(n, q) 
    ...
    & & & \mbox{where $w_{1} = \quotep{(\binpar{b_{l}(q,n)}{b_{r}(v,x^{-})})}$, $w_{2} = \quotep{(\binpar{m(q,n)}{b_{r}(v,x^{-})})}$,} \\
    & & & \mbox{$w_{3} = \quotep{(\binpar{b_{r}(p,v)}{b_{r}(v,x^{-})})}$, and $n' = \quotep{(s(w_{1},w_{2},w_{3}))}$} \\
(XIII)&  \meaningof{\prefix{p}{x}{(s(v,x^{-},w))}}_4(n, q) 
    & := & 
    \meaningof{\prefix{p}{x}{\prefix{a}{x}{(\binpar{s(v,w_{1},w_{2})}{\binpar{m(w_{1},x)}{bl(w_{2},w)}})}}}_{4}(n', q) \\
    & & & \mbox{where $w_{1} = @(\binpar{b_{l}(q,n)}{b_{r}(v,x^{-})})$, $w_{2} = @(\binpar{m(q,*n)}{b_{r}(v,x^{-})})$,} \\
    & & & \mbox{and $w_{3} = @(\binpar{b_{r}(p,v)}{b_{r}(v,x^{-})})$, $n' = \quotep{(s(w_{1},w_{2},w_{3}))}$}
\end{array}\]
