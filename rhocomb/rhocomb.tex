...
(VIII)&  \meaningof{\prefix{p}{x}{(f(x,v))}}_4(n, q) 
    & := & 
    b_{l}(p,v) \\
(IX)&  \meaningof{\prefix{p}{x}{(f(v,x))}}_4(n, q) 
    & := & 
    b_{r}(p,v) \\
(X)&  \meaningof{\prefix{p}{x}{\emph{c}(\vect{v},x^{+},\vect{w})}}_4(n, q) 
    & := & 
    \meaningof{\prefix{p}{x}{\binpar{fw(a,x)}{\emph{c}(\vect{v},a,\vect{w})}}}_f(n, q')
    \mbox{where $a = @(m(q,n)|\emph{c}(v^{-},w))$} \\
    & & & \mbox{and $q'= \quotep{(m(a,m(q,n)))}$} \\
(XI)&  \meaningof{\prefix{p}{x}{(\emph{c}(x^{-},v))}}_4(n, q) 
    & := & 
    \meaningof{\prefix{p}{x}{\binpar{fw(x,a)}{\emph{c}(a^{-},\vect{v})}}}_f(n, q')
